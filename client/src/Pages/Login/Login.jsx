    ...
    <div className="h-screen flex">
          <div className="container-image flex w-full  justify-center items-center bg-slate-700	 ">
            ...
            <form className="bg-white rounded-md shadow-2xl p-5">
              ...
              <button onClick={()=>buttonNav()} type="submit" className="block w-full bg-indigo-600 mt-5 py-2 rounded-2xl hover:bg-indigo-700 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2">Login</button>
